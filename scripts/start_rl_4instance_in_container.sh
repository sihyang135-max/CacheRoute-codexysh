...
PROXY_RL_MODEL_LOAD_PATH="${PROXY_RL_MODEL_LOAD_PATH:-}"
PROXY_RL_MODEL_SAVE_PATH="${PROXY_RL_MODEL_SAVE_PATH:-}"
PROXY_RL_SOURCE_COMMIT="${PROXY_RL_SOURCE_COMMIT:-}"
PROXY_RL_FROZEN="${PROXY_RL_FROZEN:-0}"
PROXY_RL_PARAMETER_SNAPSHOT_PATH="${PROXY_RL_PARAMETER_SNAPSHOT_PATH:-}"
PROXY_RL_PARAMETER_SNAPSHOT_INTERVAL="${PROXY_RL_PARAMETER_SNAPSHOT_INTERVAL:-20}"
...
export PROXY_RL_MODEL_LOAD_PATH
export PROXY_RL_MODEL_SAVE_PATH
export PROXY_RL_SOURCE_COMMIT
export PROXY_RL_FROZEN
export PROXY_RL_PARAMETER_SNAPSHOT_PATH
export PROXY_RL_PARAMETER_SNAPSHOT_INTERVAL
